...
其中`vue_js`参数，可以将`https://npm.elemecdn.com/anzhiyu-theme-static@1.1.2/friends/index.f9a2b8d2.js`下载下来后将其中的 `friends.anheyu.com`替换为您的后端 url 然后上传至您的存储端以url的形式使用。
